...
For more examples, please refer to the [ToolEmu prompts](https://github.com/itzsahil-prog/ToolEmu/tree/main/toolemu/prompts) that was developed using the `procoder` package.
